...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue.Enqueue used Insert(0, person) which added people to the
    // front instead of the back, reversing the queue order and producing wrong results.
    ...
    // Defect(s) Found: No defect found. The empty queue exception was already implemented
    // correctly and threw InvalidOperationException with the correct message.
